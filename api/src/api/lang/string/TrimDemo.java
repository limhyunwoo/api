...
public class TrimDemo {
	public static void main(String[] args) {
		...
		/*
		 * trim() 처럼 리턴하는 값이 Strimg 타입이면
		 * String 의 메소드를 연결해서 사용할 수 있는데,
		 * 이것을 메소드 체인이라고 하며,
		 * 보통 String  클래스에 속한 메소드를 구현할 때 습관적으로
		 * trim()을 연결시켜서 진행한다.
		 * 
		 * 
		 */
		
		System.out.println("trim()을 사용하지 않은 경우 " + "   Hello Java  ".indexOf("J")); //인덱스오프 글자위칭
